        ...
        <div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                ...
                <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full max-w-3xl">
                                    ...
                                    <form id="rule-form">
                                        <div class="mt-10 grid grid-cols-12 gap-x-6 gap-y-8 ">
                                            <div class="col-span-4">
                                                <label for="field_1" class="block text-sm font-medium leading-6 text-gray-900">Field 1</label>
                                                <div class="mt-2">
                                            ...
                                            <div class="col-span-4 col-start-2">
                                                ...
                                                <div class="mt-2 space-y-6">
                                                    <div class="flex items-center gap-x-3">
                                                        <input checked id="recommendation-reject" name="recommendation" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                                                        <label for="recommendation-reject" class="block text-sm font-medium leading-6 text-gray-900">Reject</label>
                                                    
                                                        <input id="recommendation-approve" name="recommendation" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                    ...
                    <button onClick={() => setShowForm(false)} type="button" class="inline-flex w-full justify-center rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 sm:ml-3 sm:w-auto">Save</button>
